            ...
            <ul class="nav nav-pills flex-column mb-0">
                ...
                <li class="nav-item my-3" title="Technologie">
                    <a class="nav-link" href="#technologie">
                        <svg class="centerSVG colorSVGIcon" xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" class="bi bi-filetype-java" viewBox="0 0 16 16">
            ...
            <div class="row text-white">
                <div class="mx-auto col-8">
                    <div class="mx-auto my-5 fw-bold ">
                        <p class="text-center mockTitle">Script Mock</p>
                    </div>
                    <div class="row mb-15" id="contexte">
                        <div class="row mx-auto">
                            <div class="col-auto">
                                <img src="images/stagiaire.png" class="float-start stagiaireImg">
                            </div>
                 
                            <div class="col my-auto">
                                <p class="fs-5">
                                    Dans le cadre de ma deuxième année de 
                                    ...
                                    l’entrepise <a href="https://www.eticket.qiis.fr/" target="_blank" class="text-decoration-none text-purple link">QIIS</a> pour travailler sur leur 
                                    solution eTicket.
                                </p>
                                <p class="fs-5">
                                    Cette solution permet de simplifier la vie des 
                                    communes ainsi que des familles pour toutes les 
                                    actvités périscolaires de leurs enfants.
                                    Je suis intervenu sur la partie facturarion de 
                                    l’application. 
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="container mb-15" id="technologie">
                        <div class="row">
                            ...
                            <div class=" mx-auto px-5 py-5 rounded-5 textMonProjet position-relative">
                                ...
                                <div>
                                    <p class="fs-5">
                                        <a href="https://maven.apache.org/" target="_blank" class="text-decoration-none text-purple link"><strong>Java Maven :</strong></a> Maven est un outil open source de gestion de projet et 
                                        de construction de logiciels pour les projets Java. Il simplifie la gestion 
                                        des dépendances et fournit un cadre de travail pour la compilation, le 
                                        test, le packaging, la distribution et la documentation des projets Java.*
                                    </p>
                                    <p class="fs-5 m-0">
                                        Principales dépendances :
                                    </p>
                                        <ol class="fs-5 m-0"><a href="https://www.jacoco.org/" target="_blank" class="text-decoration-none text-purple link">- Jacoco</a></ol>
                                        <ol class="fs-5 m-0"><a href="https://junit.org/junit5/" target="_blank" class="text-decoration-none text-purple link">- JUnit 5</a></ol>
                                        <ol class="fs-5 m-0"><a href="https://commons.apache.org/proper/commons-cli/" target="_blank" class="text-decoration-none text-purple link">- Apache Common CLI</a></ol>
                                </div>
                            </div>
                    ...
                    <div class="mb-15" id="objectif">
                        <h1>L'objectif :</h1>
                        <p class="fs-5">
                            <strong>Problématique :</strong> Les scripts de facturation sont écris en 
                            <a href="https://groovy-lang.org/index.html" target="_blank" class="text-decoration-none text-purple link">Groovy</a>. 
                            Pour tester ces derniers il est nécessaire de lancer tout l’environnement 
                            <a href="https://www.eticket.qiis.fr/" target="_blank" class="text-decoration-none text-purple link">eTicket</a> qui est assez lourd, cela représente une énorme perte de temps pour 
                            simplement tester un script de facturation. 
                        </p>
                        <p class="fs-5">
                            <strong>Mon travail :</strong> Je vais alors créer un environnement simplifier en utilisant seulement les parties 
                            de l’application qui permettent de tester un script de facturation. Je vais ensuite créer un 
                            jeu de données de test modulable pour répondre aux différentes possibilités d’un script. 
                        </p>
                    </div>
                    ...
                    <div class="mb-15" id="procede">
                        ...
                        <img src="images/procede.png" class="img-fluid procedeImg rounded-5 mb-5">

                        <p class="fs-5">
                            1re partie de stage : J’ai dû appréhender la logique métier de l’environnement 
                            <a href="https://www.eticket.qiis.fr/" target="_blank" class="text-decoration-none text-purple link">eTicket</a> 
                            pour récupérer seulement le nécessaire et récréer un environnement.
                        </p>
                        <p class="fs-5">
                            2nd partie de stage : Mise en place d’un générateur de données modulables. Ce générateur 
                            permet de recréer un jeu de données avec différents paramètres qui est modulable grâce 
                            aux différents paramètres de la commande. Le générateur se lance grâce à une ligne de 
                            commande où le développeur choisit ses paramètres pour avoir le jeu de données qui lui 
                            convient au maximum.
                        </p>
                        <p class="fs-5">
                            Pour que le script de facturation soit valide il doit répondre à une couverture de test de 
                            100%. Cette couverture est générée par la dépendance Jacoco.
                        </p>
                    </div>
                    ...
                    <div class="">
                        <p class="text-center text-purple">
                            Merci à <a href="https://www.eticket.qiis.fr/" target="_blank"><img src="images/qiis.png" class="iconQIIS" title="QIIS"></a>pour ce stage
                        </p>
                    </div>
                </div>
            </div>
