...
<html lang="fr">
    ...
    <body>
        ...
        <div class="m-4">
            <div class="card text-white" style="width: 300px; height: 500px;">
                <img src="images/Projet_Pygame_miniature.jpg" class="card-img-top test" alt="...">

                <div class="card-img-overlay">

                    <p class="fs-4 fw-bold mb-3 card-title d-block">Le jeu le plus dur du monde</p>
                    ...
                    <a href="#" class="d-block">
                        <div>
                            <p class="fs-6 rounded-5 d-inline position-absolute px-3 py-1 btnMorePy">
                                Voir plus
                            </p>
                        </div>
                    </a>
        ...
        <div class="container">
            <div class="row col-10 mx-auto" id="projet">

                <div class="example m-3 p-0" style="width: 300px; height: 450px;" >
                    ...
                    <div class="fadedbox text-start p-3">
                        ...
                        <a href="#" class="d-block">
                            <div>
                                <p class="fs-6 rounded-5 d-inline position-absolute px-3 py-1 btnMoreCs">
                                    Voir plus
                                </p>
                            </div>
                        </a>
                ...
                <div class="example m-3 p-0" style="width: 300px; height: 450px;" >
                    ...
                    <div class="fadedbox text-start p-3">
                        ...
                        <a href="#" class="d-block">
                            <div>
                                <p class="fs-6 rounded-5 d-inline position-absolute px-3 py-1 btnMorePHP">
                                    Voir plus
                                </p>
                            </div>
                        </a>
                ...
                <div class="example m-3 p-0" style="width: 300px; height: 450px;" >
                    ...
                    <div class="fadedbox text-start p-3">
                        ...
                        <a href="#" class="d-block">
                            <div>
                                <p class="fs-6 rounded-5 d-inline position-absolute px-3 py-1 btnMoreLa">
                                    Voir plus
                                </p>
                            </div>
                        </a>
