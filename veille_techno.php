    ...
    <body>
        ...
        <!-- <nav id="navbar-example2 " class="navbar"> -->
            <div class="vertical-nav test2 mt-0 shadow-lg" id="sidebar">
                <ul class="nav nav-pills flex-column mb-0">
                    ...
                    <!-- Icon comment ça marche -->
                    <li class="nav-item my-3 dropdown" title="Comment ça marche ?">
                        <a class="nav-link" href="#ccm">
        ...
        <main data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example" tabindex="0">
            <div class="ms-10 text-white">
                ...
                <div class="col-8 mx-auto" id="ccm">
                ...
                <div class="col-6 mx-auto outilVeille rounded-5 my-5" id="outils">
                    ...
                    <div class="ps-3 pb-2">
                        ...
                        <div class="row ms-5 my-3">
                            <a href="https://www.youtube.com/@RomainLanery" target="_blank" class="col-auto me-2">
                        ...
                        <div class="row ms-5 my-3">
                            <a href="https://www.youtube.com/@Hasheur" target="_blank" class="col-auto me-2">
                        ...
                        <div class="row ms-5 my-3">
                            <a href="https://www.usine-digitale.fr/" target="_blank" class="col-auto me-2">
                        ...
                        <div class="row ms-5 my-3">
                            <a href="https://iphonesoft.fr/" target="_blank" class="col-auto me-2">
