                ...
                <div class="vertical-nav mt-0 test2" id="sidebar">
                    ...
                    <li class="nav-item my-3" title="Articles">
                        <a class="nav-link" href="#articles">
                            <svg class="centerSVG colorSVGIcon my-1" xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" class="bi bi-journal-text" viewBox="0 0 16 16">
