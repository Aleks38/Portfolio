...
<html lang="fr">
    ...
    <body class="row">
        ...
        <main data-bs-spy="scroll" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example ps-5 px-0" tabindex="0">
            <!-- Accueuil -->
                ...
                <div class="row mx-auto">
                    ...
                    <div class="col mb-0 rounded-4 mx-2 textMonProjet">
                        ...
                        <div class="mb-0 row">
                            ...
                            <div class="offset-md-1 my-2 col-md-11">
                                <p class="text-start">Bac Général option Mathématiques, Physique Chimie et Numérique et Science Informatique</p>
                            </div>  
                        </div>
                    </div>
                ...
                <div class="row col-10 mx-auto" >
                    ...
                    <div class="example m-2 p-0 rounded-3" style="width: 300px; height: 450px;">
                        ...
                        <div class="fadedbox text-start p-3">
                            ...
                            <a href="gestion_de_ticket.php" class="d-block">
                    ...
                    <!-- Projet Script Mock -->
                    <div class="example m-2 p-0 rounded-3" style="width: 300px; height: 450px;">
                        <img class="imgCards" src="images/Projet_Script_Mock.png" />
                        
                        <div class="fadedbox text-start p-3">
                            <p class="fs-4 fw-bold mb-3 card-title d-block text-start">Script Mock</p>
                            <p class="fs-6 mb-3 card-text d-block">Ce projet consite en la création d'un environnement simplifier de la plateforme <strong>eTicket</strong> pour pouvoir gagner en productivité sur le test des scripts de facturation que les développeurs créent. J'ai pu réaliser cela lors de mon stage dans l'entreprise <strong>QIIS</strong> basée à Voiron en Isère.</p>
                            <p class="fs-6 fw-bold card-text d-block">Stage BTS SIO 2nd année</p>
                            <div class="d-block my-4">
                                <div class="d-inline">
                                    <svg width="2em" height="2em" viewBox="0 0 32 32">
                                        <defs>
                                            <linearGradient id="a" x1="-7274.8" y1="2082.507" x2="-7243.872" y2="2046.343" gradientTransform="matrix(-0.023, -0.116, -0.116, 0.023, 79.68, -889.484)" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#f69923"/>
                                                <stop offset="0.312" stop-color="#f79a23"/><stop offset="0.838" stop-color="#e97826"/>
                                            </linearGradient>
                                            ...
                                            <linearGradient id="j" x1="-8307.632" y1="2040.008" x2="-8276.704" y2="2003.844" gradientTransform="matrix(0.074, -0.112, -0.112, -0.074, 864.083, -775.51)" xlink:href="#a"/>
                                            <linearGradient id="k" x1="-8536.521" y1="2044.096" x2="-8315.868" y2="2044.096" gradientTransform="matrix(0.074, -0.112, -0.112, -0.074, 864.083, -775.51)" xlink:href="#b"/>
                                            <linearGradient id="l" x1="-8509.885" y1="2021.921" x2="-8378.397" y2="2021.921" gradientTransform="matrix(0.074, -0.112, -0.112, -0.074, 864.083, -775.51)" xlink:href="#c"/>
                                            <linearGradient id="m" x1="-8524.128" y1="2046.134" x2="-8303.475" y2="2046.134" gradientTransform="matrix(0.074, -0.112, -0.112, -0.074, 864.083, -775.51)" xlink:href="#b"/>
                                            <linearGradient id="n" x1="-8508.035" y1="2043.111" x2="-8392.076" y2="2043.111" gradientTransform="matrix(0.074, -0.112, -0.112, -0.074, 864.083, -775.51)" xlink:href="#c"/>
                                            <linearGradient id="o" x1="-8524.128" y1="2023.3" x2="-8303.475" y2="2023.3" gradientTransform="matrix(0.074, -0.112, -0.112, -0.074, 864.083, -775.51)" xlink:href="#b"/>
                                            <linearGradient id="p" x1="-8537.816" y1="2024.407" x2="-8317.163" y2="2024.407" gradientTransform="matrix(0.074, -0.112, -0.112, -0.074, 864.083, -775.51)" xlink:href="#b"/>
                                            <linearGradient id="q" x1="-8524.128" y1="2016.46" x2="-8303.475" y2="2016.46" gradientTransform="matrix(0.074, -0.112, -0.112, -0.074, 864.083, -775.51)" xlink:href="#b"/>
                                            <linearGradient id="r" x1="-8524.128" y1="2017.263" x2="-8303.475" y2="2017.263" gradientTransform="matrix(0.074, -0.112, -0.112, -0.074, 864.083, -775.51)" xlink:href="#b"/>
                                        </defs>
                                        <title>file_type_maven</title>
                                        <path d="M5.976,2.533a9.539,9.539,0,0,0-.4,2.655l1.427.691a17.928,17.928,0,0,1,.1-2.541c.005-.058.011-.092.011-.092,0,.031-.009.061-.011.092A15.939,15.939,0,0,0,7.1,5.845a27.79,27.79,0,0,0,2.114-2A3.041,3.041,0,0,0,7.621,2.144S6.357,1.634,5.976,2.533Z" style="fill:url(#a)"/>
                                        ...
                                        <path d="M10.924,13.495c-.067.073-.136.142-.206.211h0c.036-.033.073-.072.107-.108A1.212,1.212,0,0,0,10.924,13.495Z" style="fill:#be202e"/>
                                        <path d="M10.924,13.495c-.067.073-.136.142-.206.211h0c.036-.033.073-.072.107-.108A1.212,1.212,0,0,0,10.924,13.495Z" style="fill:#be202e;opacity:0.3499999940395355;isolation:isolate"/>
                                        <path d="M10.4,12.356h0c.012-.009.021-.021.032-.03.045-.045.09-.09.128-.136-.05.055-.107.108-.161.166Z" style="fill:#be202e"/>
                                        <path d="M10.4,12.356h0c.012-.009.021-.021.032-.03.045-.045.09-.09.128-.136-.05.055-.107.108-.161.166Z" style="fill:#be202e;opacity:0.3499999940395355;isolation:isolate"/>
                                        ...
                                        <path d="M10.4,12.359c.012-.009.021-.021.036-.033-.012.009-.021.021-.036.033Z" style="fill:#be202e;opacity:0.3499999940395355;isolation:isolate"/>
                                        <path d="M10.4,12.359c.012-.009.021-.021.036-.033-.012.009-.021.021-.036.033Z" style="fill:url(#i)"/>
                                        <path d="M24.627,2.891A10.789,10.789,0,0,0,22.2,4.713l.6,1.69a20.278,20.278,0,0,1,2.1-1.965c.051-.042.082-.066.082-.066-.026.024-.056.042-.082.066a18.028,18.028,0,0,0-2,2.013,31.432,31.432,0,0,0,3.288.072,3.44,3.44,0,0,0,.071-2.639S25.647,2.47,24.627,2.891Z" style="fill:url(#j)"/>
                                        ...
                                        <path d="M19.9,15.646c-.112.006-.223.006-.334.006h0c.055,0,.116,0,.172,0A1.371,1.371,0,0,0,19.9,15.646Z" style="fill:#be202e"/>
                                        <path d="M19.9,15.646c-.112.006-.223.006-.334.006h0c.055,0,.116,0,.172,0A1.371,1.371,0,0,0,19.9,15.646Z" style="fill:#be202e;opacity:0.3499999940395355;isolation:isolate"/>
                                        <path d="M20.384,14.314h0c.016,0,.033,0,.05,0,.072,0,.144,0,.212-.008-.084,0-.172,0-.261.006Z" style="fill:#be202e"/>
                                        <path d="M20.384,14.314h0c.016,0,.033,0,.05,0,.072,0,.144,0,.212-.008-.084,0-.172,0-.261.006Z" style="fill:#be202e;opacity:0.3499999940395355;isolation:isolate"/>
                                        ...
                                        <path d="M12.17,18.686a16.808,16.808,0,0,0-.583,2.01c0,.022-.013.048-.016.07a4.37,4.37,0,0,0-1.086-1.251,6.074,6.074,0,0,1,.805,2.973,2.792,2.792,0,0,1-1.339-.435,2.782,2.782,0,0,0,1.068.883,3.4,3.4,0,0,0-1.747.575,3.488,3.488,0,0,1,1.984-.069C10.2,25.432,9.12,27.645,8.015,30a.652.652,0,0,0,.5-.364c.2-.426,1.51-3.226,3.453-6.872.054-.1.113-.205.168-.314.016-.031.03-.057.046-.087q.308-.57.637-1.17c.052-.092.1-.18.151-.272v-.005l-.771-2.3A.4.4,0,0,0,12.17,18.686Z" style="fill:url(#n)"/>
                                        ...
                                        <path d="M19.738,15.655c-.056,0-.111,0-.172,0h0A1.573,1.573,0,0,1,19.738,15.655Z" style="fill:#be202e;opacity:0.3499999940395355;isolation:isolate"/>
                                        ...
                                        <path d="M20.378,14.313c.016,0,.033,0,.055,0-.016,0-.033,0-.055,0Z" style="fill:#be202e;opacity:0.3499999940395355;isolation:isolate"/>
                            ...
                            <a href="script_mock.php" class="d-block">
                                <div class="fs-6 rounded-5 position-absolute px-3 py-1 btnMoreMa row">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-github col-auto my-auto p-0 me-2" viewBox="0 0 16 16">
                                        <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"/>
                                    </svg>
                                    <p class="col-auto m-0 pe-0">
