...
<html lang="fr">
    ...
    <body>
        ...
        <nav id="navbar-example2 shadow-lg" class="navbar col d-inline">
        ...
        <main data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example mx-auto" tabindex="0">
            <!-- Accueuil -->
